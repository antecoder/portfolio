...
@include('includes.head', [
    'title' => 'Joey Dalu - Portfolio', 'css' => 'css/portfolio.css'
])
<nav class=top-bar>
    <div class=top-bar-content><a class=home-link href="{{route("home")}}"><span>Joey Dalu</span></a></div>
</nav>
<div class=page-content>
    ...
    <main>
        @php
            $projects = \App\Project::query()->orderBy('start', 'desc')->get();
        @endphp
